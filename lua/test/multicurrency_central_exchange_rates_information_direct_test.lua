...
describe("MulticurrencyCentralExchangeRatesInformationDirect", function()
  it("should direct-load-multicurrency_central_exchange_rates_information", function()
    local setup = multicurrency_central_exchange_rates_information_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-multicurrency_central_exchange_rates_information", setup.live and "live" or "unit")
