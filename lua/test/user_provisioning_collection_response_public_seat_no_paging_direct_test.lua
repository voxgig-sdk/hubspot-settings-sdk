...
describe("UserProvisioningCollectionResponsePublicSeatNoPagingDirect", function()
  it("should direct-list-user_provisioning_collection_response_public_seat_no_paging", function()
    local setup = user_provisioning_collection_response_public_seat_no_paging_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-user_provisioning_collection_response_public_seat_no_paging", setup.live and "live" or "unit")
