...
describe("MulticurrencyCompanyCurrencyDirect", function()
  it("should direct-load-multicurrency_company_currency", function()
    local setup = multicurrency_company_currency_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-multicurrency_company_currency", setup.live and "live" or "unit")
