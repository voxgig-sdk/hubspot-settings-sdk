...
describe("MulticurrencyExchangeRateDirect", function()
  it("should direct-load-multicurrency_exchange_rate", function()
    local setup = multicurrency_exchange_rate_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-multicurrency_exchange_rate", setup.live and "live" or "unit")
