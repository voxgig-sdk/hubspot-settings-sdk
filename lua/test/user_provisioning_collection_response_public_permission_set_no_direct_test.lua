...
describe("UserProvisioningCollectionResponsePublicPermissionSetNoDirect", function()
  it("should direct-list-user_provisioning_collection_response_public_permission_set_no", function()
    local setup = user_provisioning_collection_response_public_permission_set_no_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-user_provisioning_collection_response_public_permission_set_no", setup.live and "live" or "unit")
