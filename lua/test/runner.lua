...
function runner.env_override(m)
  local live = runner.getenv("HUBSPOT_SETTINGS_TEST_LIVE")
  local override = runner.getenv("HUBSPOT_SETTINGS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("HUBSPOT_SETTINGS_TEST_EXPLAIN")
