...
describe("MulticurrencyCollectionResponseExchangeRateForwardPagingDirect", function()
  it("should direct-list-multicurrency_collection_response_exchange_rate_forward_paging", function()
    local setup = multicurrency_collection_response_exchange_rate_forward_paging_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-multicurrency_collection_response_exchange_rate_forward_paging", setup.live and "live" or "unit")
