...
describe("UserProvisioningPublicUserDirect", function()
  it("should direct-load-user_provisioning_public_user", function()
    local setup = user_provisioning_public_user_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-user_provisioning_public_user", setup.live and "live" or "unit")
