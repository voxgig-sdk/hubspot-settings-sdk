...
local TeamsTeamEntity = {}
TeamsTeamEntity.__index = TeamsTeamEntity


function TeamsTeamEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TeamsTeamEntity)
  self._name = "teams_team"
  self._client = client
...
function TeamsTeamEntity:get_name()
  return self._name
end


function TeamsTeamEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TeamsTeamEntity.new(self._client, opts)
end
...
function TeamsTeamEntity:mark_deleted()
  self._deleted = true
end


function TeamsTeamEntity:deleted()
  return true == self._deleted
end


function TeamsTeamEntity:data_set(args)
  if args ~= nil then
...
function TeamsTeamEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TeamsTeamEntity:match_set(args)
  if args ~= nil then
...
function TeamsTeamEntity:match_get()
...
function TeamsTeamEntity:stream(action, args, callopts)
...
---@param reqmatch TeamsTeamLoadMatch
---@param ctrl? table
---@return TeamsTeam
---@return string? err
function TeamsTeamEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata TeamsTeamCreateData
---@param ctrl? table
---@return TeamsTeam
---@return string? err
function TeamsTeamEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata TeamsTeamUpdateData
---@param ctrl? table
---@return TeamsTeam
---@return string? err
function TeamsTeamEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function TeamsTeamEntity:_run_op(ctx, post_done)
  local utility = self._utility
