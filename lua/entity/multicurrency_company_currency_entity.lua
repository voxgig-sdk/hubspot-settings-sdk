...
local MulticurrencyCompanyCurrencyEntity = {}
MulticurrencyCompanyCurrencyEntity.__index = MulticurrencyCompanyCurrencyEntity


function MulticurrencyCompanyCurrencyEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MulticurrencyCompanyCurrencyEntity)
  self._name = "multicurrency_company_currency"
  self._client = client
...
function MulticurrencyCompanyCurrencyEntity:get_name()
  return self._name
end


function MulticurrencyCompanyCurrencyEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MulticurrencyCompanyCurrencyEntity.new(self._client, opts)
end
...
function MulticurrencyCompanyCurrencyEntity:mark_deleted()
  self._deleted = true
end


function MulticurrencyCompanyCurrencyEntity:deleted()
  return true == self._deleted
end


function MulticurrencyCompanyCurrencyEntity:data_set(args)
  if args ~= nil then
...
function MulticurrencyCompanyCurrencyEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MulticurrencyCompanyCurrencyEntity:match_set(args)
  if args ~= nil then
...
function MulticurrencyCompanyCurrencyEntity:match_get()
...
function MulticurrencyCompanyCurrencyEntity:stream(action, args, callopts)
...
---@param reqmatch MulticurrencyCompanyCurrencyLoadMatch
---@param ctrl? table
---@return MulticurrencyCompanyCurrency
---@return string? err
function MulticurrencyCompanyCurrencyEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata MulticurrencyCompanyCurrencyUpdateData
---@param ctrl? table
---@return MulticurrencyCompanyCurrency
---@return string? err
function MulticurrencyCompanyCurrencyEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function MulticurrencyCompanyCurrencyEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MulticurrencyCompanyCurrencyEntity
