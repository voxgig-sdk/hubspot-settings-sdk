-- HubspotSettings SDK TeamsCollectionResponseTeamResponseForwardPaging entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local TeamsCollectionResponseTeamResponseForwardPagingEntity = {}
TeamsCollectionResponseTeamResponseForwardPagingEntity.__index = TeamsCollectionResponseTeamResponseForwardPagingEntity


function TeamsCollectionResponseTeamResponseForwardPagingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TeamsCollectionResponseTeamResponseForwardPagingEntity)
  self._name = "teams_collection_response_team_response_forward_paging"
  self._client = client
...
function TeamsCollectionResponseTeamResponseForwardPagingEntity:get_name()
  return self._name
end


function TeamsCollectionResponseTeamResponseForwardPagingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TeamsCollectionResponseTeamResponseForwardPagingEntity.new(self._client, opts)
end
...
function TeamsCollectionResponseTeamResponseForwardPagingEntity:mark_deleted()
  self._deleted = true
end


function TeamsCollectionResponseTeamResponseForwardPagingEntity:deleted()
  return true == self._deleted
end


function TeamsCollectionResponseTeamResponseForwardPagingEntity:data_set(args)
  if args ~= nil then
...
function TeamsCollectionResponseTeamResponseForwardPagingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TeamsCollectionResponseTeamResponseForwardPagingEntity:match_set(args)
  if args ~= nil then
...
function TeamsCollectionResponseTeamResponseForwardPagingEntity:match_get()
...
function TeamsCollectionResponseTeamResponseForwardPagingEntity:stream(action, args, callopts)
...
---@param reqmatch TeamsCollectionResponseTeamResponseForwardPagingListMatch
---@param ctrl? table
---@return TeamsCollectionResponseTeamResponseForwardPaging[]
---@return string? err
function TeamsCollectionResponseTeamResponseForwardPagingEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function TeamsCollectionResponseTeamResponseForwardPagingEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return TeamsCollectionResponseTeamResponseForwardPagingEntity
