-- HubspotSettings SDK MulticurrencyCollectionResponseExchangeRateForwardPaging entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local MulticurrencyCollectionResponseExchangeRateForwardPagingEntity = {}
MulticurrencyCollectionResponseExchangeRateForwardPagingEntity.__index = MulticurrencyCollectionResponseExchangeRateForwardPagingEntity


function MulticurrencyCollectionResponseExchangeRateForwardPagingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MulticurrencyCollectionResponseExchangeRateForwardPagingEntity)
  self._name = "multicurrency_collection_response_exchange_rate_forward_paging"
  self._client = client
...
function MulticurrencyCollectionResponseExchangeRateForwardPagingEntity:get_name()
  return self._name
end


function MulticurrencyCollectionResponseExchangeRateForwardPagingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MulticurrencyCollectionResponseExchangeRateForwardPagingEntity.new(self._client, opts)
end
...
function MulticurrencyCollectionResponseExchangeRateForwardPagingEntity:mark_deleted()
  self._deleted = true
end


function MulticurrencyCollectionResponseExchangeRateForwardPagingEntity:deleted()
  return true == self._deleted
end


function MulticurrencyCollectionResponseExchangeRateForwardPagingEntity:data_set(args)
  if args ~= nil then
...
function MulticurrencyCollectionResponseExchangeRateForwardPagingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MulticurrencyCollectionResponseExchangeRateForwardPagingEntity:match_set(args)
  if args ~= nil then
...
function MulticurrencyCollectionResponseExchangeRateForwardPagingEntity:match_get()
...
function MulticurrencyCollectionResponseExchangeRateForwardPagingEntity:stream(action, args, callopts)
...
---@param reqmatch MulticurrencyCollectionResponseExchangeRateForwardPagingListMatch
---@param ctrl? table
---@return MulticurrencyCollectionResponseExchangeRateForwardPaging[]
---@return string? err
function MulticurrencyCollectionResponseExchangeRateForwardPagingEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function MulticurrencyCollectionResponseExchangeRateForwardPagingEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MulticurrencyCollectionResponseExchangeRateForwardPagingEntity
