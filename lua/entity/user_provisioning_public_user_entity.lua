...
local UserProvisioningPublicUserEntity = {}
UserProvisioningPublicUserEntity.__index = UserProvisioningPublicUserEntity


function UserProvisioningPublicUserEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UserProvisioningPublicUserEntity)
  self._name = "user_provisioning_public_user"
  self._client = client
...
function UserProvisioningPublicUserEntity:get_name()
  return self._name
end


function UserProvisioningPublicUserEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return UserProvisioningPublicUserEntity.new(self._client, opts)
end
...
function UserProvisioningPublicUserEntity:mark_deleted()
  self._deleted = true
end


function UserProvisioningPublicUserEntity:deleted()
  return true == self._deleted
end


function UserProvisioningPublicUserEntity:data_set(args)
  if args ~= nil then
...
function UserProvisioningPublicUserEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UserProvisioningPublicUserEntity:match_set(args)
  if args ~= nil then
...
function UserProvisioningPublicUserEntity:match_get()
...
function UserProvisioningPublicUserEntity:stream(action, args, callopts)
...
---@param reqmatch UserProvisioningPublicUserLoadMatch
---@param ctrl? table
---@return UserProvisioningPublicUser
---@return string? err
function UserProvisioningPublicUserEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata UserProvisioningPublicUserCreateData
---@param ctrl? table
---@return UserProvisioningPublicUser
---@return string? err
function UserProvisioningPublicUserEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata UserProvisioningPublicUserUpdateData
---@param ctrl? table
---@return UserProvisioningPublicUser
---@return string? err
function UserProvisioningPublicUserEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function UserProvisioningPublicUserEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return UserProvisioningPublicUserEntity
