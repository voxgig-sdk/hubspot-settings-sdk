-- HubspotSettings SDK UserProvisioningCollectionResponsePublicPermissionSetNo entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local UserProvisioningCollectionResponsePublicPermissionSetNoEntity = {}
UserProvisioningCollectionResponsePublicPermissionSetNoEntity.__index = UserProvisioningCollectionResponsePublicPermissionSetNoEntity


function UserProvisioningCollectionResponsePublicPermissionSetNoEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UserProvisioningCollectionResponsePublicPermissionSetNoEntity)
  self._name = "user_provisioning_collection_response_public_permission_set_no"
  self._client = client
...
function UserProvisioningCollectionResponsePublicPermissionSetNoEntity:get_name()
  return self._name
end


function UserProvisioningCollectionResponsePublicPermissionSetNoEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return UserProvisioningCollectionResponsePublicPermissionSetNoEntity.new(self._client, opts)
end
...
function UserProvisioningCollectionResponsePublicPermissionSetNoEntity:mark_deleted()
  self._deleted = true
end


function UserProvisioningCollectionResponsePublicPermissionSetNoEntity:deleted()
  return true == self._deleted
end


function UserProvisioningCollectionResponsePublicPermissionSetNoEntity:data_set(args)
  if args ~= nil then
...
function UserProvisioningCollectionResponsePublicPermissionSetNoEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UserProvisioningCollectionResponsePublicPermissionSetNoEntity:match_set(args)
  if args ~= nil then
...
function UserProvisioningCollectionResponsePublicPermissionSetNoEntity:match_get()
...
function UserProvisioningCollectionResponsePublicPermissionSetNoEntity:stream(action, args, callopts)
...
---@param reqmatch UserProvisioningCollectionResponsePublicPermissionSetNoListMatch
---@param ctrl? table
---@return UserProvisioningCollectionResponsePublicPermissionSetNo[]
---@return string? err
function UserProvisioningCollectionResponsePublicPermissionSetNoEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function UserProvisioningCollectionResponsePublicPermissionSetNoEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return UserProvisioningCollectionResponsePublicPermissionSetNoEntity
