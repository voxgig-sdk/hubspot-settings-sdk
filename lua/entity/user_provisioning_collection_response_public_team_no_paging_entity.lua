-- HubspotSettings SDK UserProvisioningCollectionResponsePublicTeamNoPaging entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local UserProvisioningCollectionResponsePublicTeamNoPagingEntity = {}
UserProvisioningCollectionResponsePublicTeamNoPagingEntity.__index = UserProvisioningCollectionResponsePublicTeamNoPagingEntity


function UserProvisioningCollectionResponsePublicTeamNoPagingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UserProvisioningCollectionResponsePublicTeamNoPagingEntity)
  self._name = "user_provisioning_collection_response_public_team_no_paging"
  self._client = client
...
function UserProvisioningCollectionResponsePublicTeamNoPagingEntity:get_name()
  return self._name
end


function UserProvisioningCollectionResponsePublicTeamNoPagingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return UserProvisioningCollectionResponsePublicTeamNoPagingEntity.new(self._client, opts)
end
...
function UserProvisioningCollectionResponsePublicTeamNoPagingEntity:mark_deleted()
  self._deleted = true
end


function UserProvisioningCollectionResponsePublicTeamNoPagingEntity:deleted()
  return true == self._deleted
end


function UserProvisioningCollectionResponsePublicTeamNoPagingEntity:data_set(args)
  if args ~= nil then
...
function UserProvisioningCollectionResponsePublicTeamNoPagingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UserProvisioningCollectionResponsePublicTeamNoPagingEntity:match_set(args)
  if args ~= nil then
...
function UserProvisioningCollectionResponsePublicTeamNoPagingEntity:match_get()
...
function UserProvisioningCollectionResponsePublicTeamNoPagingEntity:stream(action, args, callopts)
...
---@param reqmatch UserProvisioningCollectionResponsePublicTeamNoPagingListMatch
---@param ctrl? table
---@return UserProvisioningCollectionResponsePublicTeamNoPaging[]
---@return string? err
function UserProvisioningCollectionResponsePublicTeamNoPagingEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function UserProvisioningCollectionResponsePublicTeamNoPagingEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return UserProvisioningCollectionResponsePublicTeamNoPagingEntity
