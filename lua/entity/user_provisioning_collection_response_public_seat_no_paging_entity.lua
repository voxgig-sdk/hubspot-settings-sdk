-- HubspotSettings SDK UserProvisioningCollectionResponsePublicSeatNoPaging entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local UserProvisioningCollectionResponsePublicSeatNoPagingEntity = {}
UserProvisioningCollectionResponsePublicSeatNoPagingEntity.__index = UserProvisioningCollectionResponsePublicSeatNoPagingEntity


function UserProvisioningCollectionResponsePublicSeatNoPagingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UserProvisioningCollectionResponsePublicSeatNoPagingEntity)
  self._name = "user_provisioning_collection_response_public_seat_no_paging"
  self._client = client
...
function UserProvisioningCollectionResponsePublicSeatNoPagingEntity:get_name()
  return self._name
end


function UserProvisioningCollectionResponsePublicSeatNoPagingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return UserProvisioningCollectionResponsePublicSeatNoPagingEntity.new(self._client, opts)
end
...
function UserProvisioningCollectionResponsePublicSeatNoPagingEntity:mark_deleted()
  self._deleted = true
end


function UserProvisioningCollectionResponsePublicSeatNoPagingEntity:deleted()
  return true == self._deleted
end


function UserProvisioningCollectionResponsePublicSeatNoPagingEntity:data_set(args)
  if args ~= nil then
...
function UserProvisioningCollectionResponsePublicSeatNoPagingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UserProvisioningCollectionResponsePublicSeatNoPagingEntity:match_set(args)
  if args ~= nil then
...
function UserProvisioningCollectionResponsePublicSeatNoPagingEntity:match_get()
...
function UserProvisioningCollectionResponsePublicSeatNoPagingEntity:stream(action, args, callopts)
...
---@param reqmatch UserProvisioningCollectionResponsePublicSeatNoPagingListMatch
---@param ctrl? table
---@return UserProvisioningCollectionResponsePublicSeatNoPaging[]
---@return string? err
function UserProvisioningCollectionResponsePublicSeatNoPagingEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function UserProvisioningCollectionResponsePublicSeatNoPagingEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return UserProvisioningCollectionResponsePublicSeatNoPagingEntity
