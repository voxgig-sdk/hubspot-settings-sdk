-- HubspotSettings SDK TeamsBatchResponseTeamMember entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local TeamsBatchResponseTeamMemberEntity = {}
TeamsBatchResponseTeamMemberEntity.__index = TeamsBatchResponseTeamMemberEntity


function TeamsBatchResponseTeamMemberEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TeamsBatchResponseTeamMemberEntity)
  self._name = "teams_batch_response_team_member"
  self._client = client
...
function TeamsBatchResponseTeamMemberEntity:get_name()
  return self._name
end


function TeamsBatchResponseTeamMemberEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TeamsBatchResponseTeamMemberEntity.new(self._client, opts)
end
...
function TeamsBatchResponseTeamMemberEntity:mark_deleted()
  self._deleted = true
end


function TeamsBatchResponseTeamMemberEntity:deleted()
  return true == self._deleted
end


function TeamsBatchResponseTeamMemberEntity:data_set(args)
  if args ~= nil then
...
function TeamsBatchResponseTeamMemberEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TeamsBatchResponseTeamMemberEntity:match_set(args)
  if args ~= nil then
...
function TeamsBatchResponseTeamMemberEntity:match_get()
...
function TeamsBatchResponseTeamMemberEntity:stream(action, args, callopts)
...
---@param reqdata TeamsBatchResponseTeamMemberCreateData
---@param ctrl? table
---@return TeamsBatchResponseTeamMember
---@return string? err
function TeamsBatchResponseTeamMemberEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function TeamsBatchResponseTeamMemberEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return TeamsBatchResponseTeamMemberEntity
