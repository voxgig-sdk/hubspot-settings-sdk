-- HubspotSettings SDK MulticurrencyCollectionResponseExchangeRateNoPaging entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local MulticurrencyCollectionResponseExchangeRateNoPagingEntity = {}
MulticurrencyCollectionResponseExchangeRateNoPagingEntity.__index = MulticurrencyCollectionResponseExchangeRateNoPagingEntity


function MulticurrencyCollectionResponseExchangeRateNoPagingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MulticurrencyCollectionResponseExchangeRateNoPagingEntity)
  self._name = "multicurrency_collection_response_exchange_rate_no_paging"
  self._client = client
...
function MulticurrencyCollectionResponseExchangeRateNoPagingEntity:get_name()
  return self._name
end


function MulticurrencyCollectionResponseExchangeRateNoPagingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MulticurrencyCollectionResponseExchangeRateNoPagingEntity.new(self._client, opts)
end
...
function MulticurrencyCollectionResponseExchangeRateNoPagingEntity:mark_deleted()
  self._deleted = true
end


function MulticurrencyCollectionResponseExchangeRateNoPagingEntity:deleted()
  return true == self._deleted
end


function MulticurrencyCollectionResponseExchangeRateNoPagingEntity:data_set(args)
  if args ~= nil then
...
function MulticurrencyCollectionResponseExchangeRateNoPagingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MulticurrencyCollectionResponseExchangeRateNoPagingEntity:match_set(args)
  if args ~= nil then
...
function MulticurrencyCollectionResponseExchangeRateNoPagingEntity:match_get()
...
function MulticurrencyCollectionResponseExchangeRateNoPagingEntity:stream(action, args, callopts)
...
---@param reqmatch MulticurrencyCollectionResponseExchangeRateNoPagingListMatch
---@param ctrl? table
---@return MulticurrencyCollectionResponseExchangeRateNoPaging[]
---@return string? err
function MulticurrencyCollectionResponseExchangeRateNoPagingEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function MulticurrencyCollectionResponseExchangeRateNoPagingEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MulticurrencyCollectionResponseExchangeRateNoPagingEntity
