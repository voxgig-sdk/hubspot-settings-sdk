-- HubspotSettings SDK UserProvisioningCollectionResponsePublicUserForwardPaging entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local UserProvisioningCollectionResponsePublicUserForwardPagingEntity = {}
UserProvisioningCollectionResponsePublicUserForwardPagingEntity.__index = UserProvisioningCollectionResponsePublicUserForwardPagingEntity


function UserProvisioningCollectionResponsePublicUserForwardPagingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UserProvisioningCollectionResponsePublicUserForwardPagingEntity)
  self._name = "user_provisioning_collection_response_public_user_forward_paging"
  self._client = client
...
function UserProvisioningCollectionResponsePublicUserForwardPagingEntity:get_name()
  return self._name
end


function UserProvisioningCollectionResponsePublicUserForwardPagingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return UserProvisioningCollectionResponsePublicUserForwardPagingEntity.new(self._client, opts)
end
...
function UserProvisioningCollectionResponsePublicUserForwardPagingEntity:mark_deleted()
  self._deleted = true
end


function UserProvisioningCollectionResponsePublicUserForwardPagingEntity:deleted()
  return true == self._deleted
end


function UserProvisioningCollectionResponsePublicUserForwardPagingEntity:data_set(args)
  if args ~= nil then
...
function UserProvisioningCollectionResponsePublicUserForwardPagingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UserProvisioningCollectionResponsePublicUserForwardPagingEntity:match_set(args)
  if args ~= nil then
...
function UserProvisioningCollectionResponsePublicUserForwardPagingEntity:match_get()
...
function UserProvisioningCollectionResponsePublicUserForwardPagingEntity:stream(action, args, callopts)
...
---@param reqmatch UserProvisioningCollectionResponsePublicUserForwardPagingListMatch
---@param ctrl? table
---@return UserProvisioningCollectionResponsePublicUserForwardPaging[]
---@return string? err
function UserProvisioningCollectionResponsePublicUserForwardPagingEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function UserProvisioningCollectionResponsePublicUserForwardPagingEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return UserProvisioningCollectionResponsePublicUserForwardPagingEntity
