-- HubspotSettings SDK TeamsCollectionResponseTeamMemberResponseForwardPaging entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local TeamsCollectionResponseTeamMemberResponseForwardPagingEntity = {}
TeamsCollectionResponseTeamMemberResponseForwardPagingEntity.__index = TeamsCollectionResponseTeamMemberResponseForwardPagingEntity


function TeamsCollectionResponseTeamMemberResponseForwardPagingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TeamsCollectionResponseTeamMemberResponseForwardPagingEntity)
  self._name = "teams_collection_response_team_member_response_forward_paging"
  self._client = client
...
function TeamsCollectionResponseTeamMemberResponseForwardPagingEntity:get_name()
  return self._name
end


function TeamsCollectionResponseTeamMemberResponseForwardPagingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TeamsCollectionResponseTeamMemberResponseForwardPagingEntity.new(self._client, opts)
end
...
function TeamsCollectionResponseTeamMemberResponseForwardPagingEntity:mark_deleted()
  self._deleted = true
end


function TeamsCollectionResponseTeamMemberResponseForwardPagingEntity:deleted()
  return true == self._deleted
end


function TeamsCollectionResponseTeamMemberResponseForwardPagingEntity:data_set(args)
  if args ~= nil then
...
function TeamsCollectionResponseTeamMemberResponseForwardPagingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TeamsCollectionResponseTeamMemberResponseForwardPagingEntity:match_set(args)
  if args ~= nil then
...
function TeamsCollectionResponseTeamMemberResponseForwardPagingEntity:match_get()
...
function TeamsCollectionResponseTeamMemberResponseForwardPagingEntity:stream(action, args, callopts)
...
---@param reqmatch TeamsCollectionResponseTeamMemberResponseForwardPagingListMatch
---@param ctrl? table
---@return TeamsCollectionResponseTeamMemberResponseForwardPaging[]
---@return string? err
function TeamsCollectionResponseTeamMemberResponseForwardPagingEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function TeamsCollectionResponseTeamMemberResponseForwardPagingEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return TeamsCollectionResponseTeamMemberResponseForwardPagingEntity
