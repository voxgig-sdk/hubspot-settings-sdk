-- HubspotSettings SDK TeamsTeamMember entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local TeamsTeamMemberEntity = {}
TeamsTeamMemberEntity.__index = TeamsTeamMemberEntity


function TeamsTeamMemberEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TeamsTeamMemberEntity)
  self._name = "teams_team_member"
  self._client = client
...
function TeamsTeamMemberEntity:get_name()
  return self._name
end


function TeamsTeamMemberEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TeamsTeamMemberEntity.new(self._client, opts)
end
...
function TeamsTeamMemberEntity:mark_deleted()
  self._deleted = true
end


function TeamsTeamMemberEntity:deleted()
  return true == self._deleted
end


function TeamsTeamMemberEntity:data_set(args)
  if args ~= nil then
...
function TeamsTeamMemberEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TeamsTeamMemberEntity:match_set(args)
  if args ~= nil then
...
function TeamsTeamMemberEntity:match_get()
...
function TeamsTeamMemberEntity:stream(action, args, callopts)
...
---@param reqdata TeamsTeamMemberCreateData
---@param ctrl? table
---@return TeamsTeamMember
---@return string? err
function TeamsTeamMemberEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function TeamsTeamMemberEntity:_run_op(ctx, post_done)
  local utility = self._utility
