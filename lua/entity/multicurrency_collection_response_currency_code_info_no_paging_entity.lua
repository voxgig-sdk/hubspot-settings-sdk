-- HubspotSettings SDK MulticurrencyCollectionResponseCurrencyCodeInfoNoPaging entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local MulticurrencyCollectionResponseCurrencyCodeInfoNoPagingEntity = {}
MulticurrencyCollectionResponseCurrencyCodeInfoNoPagingEntity.__index = MulticurrencyCollectionResponseCurrencyCodeInfoNoPagingEntity


function MulticurrencyCollectionResponseCurrencyCodeInfoNoPagingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MulticurrencyCollectionResponseCurrencyCodeInfoNoPagingEntity)
  self._name = "multicurrency_collection_response_currency_code_info_no_paging"
  self._client = client
...
function MulticurrencyCollectionResponseCurrencyCodeInfoNoPagingEntity:get_name()
  return self._name
end


function MulticurrencyCollectionResponseCurrencyCodeInfoNoPagingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MulticurrencyCollectionResponseCurrencyCodeInfoNoPagingEntity.new(self._client, opts)
end
...
function MulticurrencyCollectionResponseCurrencyCodeInfoNoPagingEntity:mark_deleted()
  self._deleted = true
end


function MulticurrencyCollectionResponseCurrencyCodeInfoNoPagingEntity:deleted()
  return true == self._deleted
end


function MulticurrencyCollectionResponseCurrencyCodeInfoNoPagingEntity:data_set(args)
  if args ~= nil then
...
function MulticurrencyCollectionResponseCurrencyCodeInfoNoPagingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MulticurrencyCollectionResponseCurrencyCodeInfoNoPagingEntity:match_set(args)
  if args ~= nil then
...
function MulticurrencyCollectionResponseCurrencyCodeInfoNoPagingEntity:match_get()
...
function MulticurrencyCollectionResponseCurrencyCodeInfoNoPagingEntity:stream(action, args, callopts)
...
---@param reqmatch MulticurrencyCollectionResponseCurrencyCodeInfoNoPagingListMatch
---@param ctrl? table
---@return MulticurrencyCollectionResponseCurrencyCodeInfoNoPaging[]
---@return string? err
function MulticurrencyCollectionResponseCurrencyCodeInfoNoPagingEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function MulticurrencyCollectionResponseCurrencyCodeInfoNoPagingEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MulticurrencyCollectionResponseCurrencyCodeInfoNoPagingEntity
