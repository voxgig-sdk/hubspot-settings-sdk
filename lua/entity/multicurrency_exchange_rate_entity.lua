...
local MulticurrencyExchangeRateEntity = {}
MulticurrencyExchangeRateEntity.__index = MulticurrencyExchangeRateEntity


function MulticurrencyExchangeRateEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MulticurrencyExchangeRateEntity)
  self._name = "multicurrency_exchange_rate"
  self._client = client
...
function MulticurrencyExchangeRateEntity:get_name()
  return self._name
end


function MulticurrencyExchangeRateEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MulticurrencyExchangeRateEntity.new(self._client, opts)
end
...
function MulticurrencyExchangeRateEntity:mark_deleted()
  self._deleted = true
end


function MulticurrencyExchangeRateEntity:deleted()
  return true == self._deleted
end


function MulticurrencyExchangeRateEntity:data_set(args)
  if args ~= nil then
...
function MulticurrencyExchangeRateEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MulticurrencyExchangeRateEntity:match_set(args)
  if args ~= nil then
...
function MulticurrencyExchangeRateEntity:match_get()
...
function MulticurrencyExchangeRateEntity:stream(action, args, callopts)
...
---@param reqmatch MulticurrencyExchangeRateLoadMatch
---@param ctrl? table
---@return MulticurrencyExchangeRate
---@return string? err
function MulticurrencyExchangeRateEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata MulticurrencyExchangeRateCreateData
---@param ctrl? table
---@return MulticurrencyExchangeRate
---@return string? err
function MulticurrencyExchangeRateEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata MulticurrencyExchangeRateUpdateData
---@param ctrl? table
---@return MulticurrencyExchangeRate
---@return string? err
function MulticurrencyExchangeRateEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function MulticurrencyExchangeRateEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MulticurrencyExchangeRateEntity
