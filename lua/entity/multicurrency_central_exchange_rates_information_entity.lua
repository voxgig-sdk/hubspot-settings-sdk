-- HubspotSettings SDK MulticurrencyCentralExchangeRatesInformation entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local MulticurrencyCentralExchangeRatesInformationEntity = {}
MulticurrencyCentralExchangeRatesInformationEntity.__index = MulticurrencyCentralExchangeRatesInformationEntity


function MulticurrencyCentralExchangeRatesInformationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MulticurrencyCentralExchangeRatesInformationEntity)
  self._name = "multicurrency_central_exchange_rates_information"
  self._client = client
...
function MulticurrencyCentralExchangeRatesInformationEntity:get_name()
  return self._name
end


function MulticurrencyCentralExchangeRatesInformationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MulticurrencyCentralExchangeRatesInformationEntity.new(self._client, opts)
end
...
function MulticurrencyCentralExchangeRatesInformationEntity:mark_deleted()
  self._deleted = true
end


function MulticurrencyCentralExchangeRatesInformationEntity:deleted()
  return true == self._deleted
end


function MulticurrencyCentralExchangeRatesInformationEntity:data_set(args)
  if args ~= nil then
...
function MulticurrencyCentralExchangeRatesInformationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MulticurrencyCentralExchangeRatesInformationEntity:match_set(args)
  if args ~= nil then
...
function MulticurrencyCentralExchangeRatesInformationEntity:match_get()
...
function MulticurrencyCentralExchangeRatesInformationEntity:stream(action, args, callopts)
...
---@param reqmatch MulticurrencyCentralExchangeRatesInformationLoadMatch
---@param ctrl? table
---@return MulticurrencyCentralExchangeRatesInformation
---@return string? err
function MulticurrencyCentralExchangeRatesInformationEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function MulticurrencyCentralExchangeRatesInformationEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MulticurrencyCentralExchangeRatesInformationEntity
