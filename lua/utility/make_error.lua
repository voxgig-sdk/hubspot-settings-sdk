...
local function make_error_util(ctx, err)
  ...
  local msg = "HubspotSettingsSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = HubspotSettingsError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == HubspotSettingsError then
