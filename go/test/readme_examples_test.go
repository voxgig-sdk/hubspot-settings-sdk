...
const testSeed = `map[string]any{"entity": map[string]any{"basic": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "exchange_rate": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "multicurrency_batch_response_exchange_rate": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "multicurrency_central_exchange_rates_information": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "multicurrency_collection_response_currency_code_info_no_paging": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "multicurrency_collection_response_exchange_rate_forward_paging": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "multicurrency_collection_response_exchange_rate_no_paging": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "multicurrency_company_currency": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "multicurrency_exchange_rate": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tax_rate": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "teams_batch_response_team_member": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "teams_collection_response_team_member_response_forward_paging": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "teams_collection_response_team_response_forward_paging": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "teams_team": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "teams_team_member": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user_provisioning_collection_response_public_permission_set_no": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user_provisioning_collection_response_public_seat_no_paging": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user_provisioning_collection_response_public_team_no_paging": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user_provisioning_collection_response_public_user_forward_paging": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user_provisioning_public_user": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
