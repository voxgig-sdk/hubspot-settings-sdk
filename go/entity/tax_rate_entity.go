...
func NewTaxRateEntity(client *core.HubspotSettingsSDK, entopts map[string]any) *TaxRateEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TaxRateEntity) GetName() string { return e.name }
...
func (e *TaxRateEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TaxRateEntity) Deleted() bool {
	return e.deleted
}


func (e *TaxRateEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTaxRateEntity(e.client, opts)
}

func (e *TaxRateEntity) Data(args ...any) any {
...
func (e *TaxRateEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TaxRate; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TaxRateEntity) DataTyped(data ...TaxRate) TaxRate {
	if len(data) > 0 {
		return typedFrom[TaxRate](e.Data(asMap(data[0])))
	}
	return typedFrom[TaxRate](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TaxRate (all fields
// optional at the wire level).
func (e *TaxRateEntity) MatchTyped(match ...TaxRate) TaxRate {
	if len(match) > 0 {
		return typedFrom[TaxRate](e.Match(asMap(match[0])))
	}
	return typedFrom[TaxRate](e.Match())
}
...
func (e *TaxRateEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TaxRateEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TaxRateLoadMatch and returns an TaxRate. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TaxRateEntity) LoadTyped(reqmatch TaxRateLoadMatch, ctrl map[string]any) (TaxRate, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return TaxRate{}, err
	}
	return typedFrom[TaxRate](res), nil
}




func (e *TaxRateEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// TaxRateListMatch and returns []TaxRate. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TaxRateEntity) ListTyped(reqmatch TaxRateListMatch, ctrl map[string]any) ([]TaxRate, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[TaxRate](res), nil
}



func (e *TaxRateEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TaxRateEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TaxRateEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TaxRateEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
