...
func NewExchangeRateEntity(client *core.HubspotSettingsSDK, entopts map[string]any) *ExchangeRateEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ExchangeRateEntity) GetName() string { return e.name }
...
func (e *ExchangeRateEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ExchangeRateEntity) Deleted() bool {
	return e.deleted
}


func (e *ExchangeRateEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewExchangeRateEntity(e.client, opts)
}

func (e *ExchangeRateEntity) Data(args ...any) any {
...
func (e *ExchangeRateEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ExchangeRate; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ExchangeRateEntity) DataTyped(data ...ExchangeRate) ExchangeRate {
	if len(data) > 0 {
		return typedFrom[ExchangeRate](e.Data(asMap(data[0])))
	}
	return typedFrom[ExchangeRate](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ExchangeRate (all fields
// optional at the wire level).
func (e *ExchangeRateEntity) MatchTyped(match ...ExchangeRate) ExchangeRate {
	if len(match) > 0 {
		return typedFrom[ExchangeRate](e.Match(asMap(match[0])))
	}
	return typedFrom[ExchangeRate](e.Match())
}
...
func (e *ExchangeRateEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ExchangeRateEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ExchangeRateEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *ExchangeRateEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ExchangeRateCreateData and returns an ExchangeRate. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ExchangeRateEntity) CreateTyped(reqdata ExchangeRateCreateData, ctrl map[string]any) (ExchangeRate, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return ExchangeRate{}, err
	}
	return typedFrom[ExchangeRate](res), nil
}



func (e *ExchangeRateEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ExchangeRateEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ExchangeRateEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
