...
type TeamsTeamMemberEntity struct {
	name    string
...
func NewTeamsTeamMemberEntity(client *core.HubspotSettingsSDK, entopts map[string]any) *TeamsTeamMemberEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TeamsTeamMemberEntity) GetName() string { return e.name }
...
func (e *TeamsTeamMemberEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TeamsTeamMemberEntity) Deleted() bool {
	return e.deleted
}


func (e *TeamsTeamMemberEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTeamsTeamMemberEntity(e.client, opts)
}

func (e *TeamsTeamMemberEntity) Data(args ...any) any {
...
func (e *TeamsTeamMemberEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TeamsTeamMember; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TeamsTeamMemberEntity) DataTyped(data ...TeamsTeamMember) TeamsTeamMember {
	if len(data) > 0 {
		return typedFrom[TeamsTeamMember](e.Data(asMap(data[0])))
	}
	return typedFrom[TeamsTeamMember](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TeamsTeamMember (all fields
// optional at the wire level).
func (e *TeamsTeamMemberEntity) MatchTyped(match ...TeamsTeamMember) TeamsTeamMember {
	if len(match) > 0 {
		return typedFrom[TeamsTeamMember](e.Match(asMap(match[0])))
	}
	return typedFrom[TeamsTeamMember](e.Match())
}
...
func (e *TeamsTeamMemberEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TeamsTeamMemberEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *TeamsTeamMemberEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *TeamsTeamMemberEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TeamsTeamMemberCreateData and returns an TeamsTeamMember. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *TeamsTeamMemberEntity) CreateTyped(reqdata TeamsTeamMemberCreateData, ctrl map[string]any) (TeamsTeamMember, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return TeamsTeamMember{}, err
	}
	return typedFrom[TeamsTeamMember](res), nil
}



func (e *TeamsTeamMemberEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TeamsTeamMemberEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TeamsTeamMemberEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
