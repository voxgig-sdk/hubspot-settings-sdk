...
from hubspotsettings_sdk.core.control import HubspotSettingsControl
...
from hubspotsettings_sdk.core.helpers import get_ctx_prop, to_map
...
class HubspotSettingsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = HubspotSettingsControl()
        ...
        if isinstance(sp, HubspotSettingsSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, HubspotSettingsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, HubspotSettingsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return HubspotSettingsOperation({})
    ...
    def make_error(self, code, msg):
        return HubspotSettingsError(code, msg, self)
