...
class TeamsCollectionResponseTeamMemberResponseForwardPagingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TeamsCollectionResponseTeamMemberResponseForwardPagingEntity(self._client, opts)
    ...
    def data_get(self) -> TeamsCollectionResponseTeamMemberResponseForwardPaging:
    ...
    def match_get(self) -> TeamsCollectionResponseTeamMemberResponseForwardPaging:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[TeamsCollectionResponseTeamMemberResponseForwardPaging]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.TeamsCollectionResponseTeamMemberResponseForwardPaging().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
