...
class UserProvisioningCollectionResponsePublicSeatNoPagingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return UserProvisioningCollectionResponsePublicSeatNoPagingEntity(self._client, opts)
    ...
    def data_get(self) -> UserProvisioningCollectionResponsePublicSeatNoPaging:
    ...
    def match_get(self) -> UserProvisioningCollectionResponsePublicSeatNoPaging:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[UserProvisioningCollectionResponsePublicSeatNoPaging]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.UserProvisioningCollectionResponsePublicSeatNoPaging().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
