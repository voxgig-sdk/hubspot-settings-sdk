...
class MulticurrencyBatchResponseExchangeRateEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MulticurrencyBatchResponseExchangeRateEntity(self._client, opts)
    ...
    def data_get(self) -> MulticurrencyBatchResponseExchangeRate:
    ...
    def match_get(self) -> MulticurrencyBatchResponseExchangeRate:
    ...
    def create(self, reqdata: MulticurrencyBatchResponseExchangeRateCreateData, ctrl=None) -> MulticurrencyBatchResponseExchangeRate:
        utility = self._utility
