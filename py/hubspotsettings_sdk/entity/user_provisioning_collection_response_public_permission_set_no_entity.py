...
class UserProvisioningCollectionResponsePublicPermissionSetNoEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return UserProvisioningCollectionResponsePublicPermissionSetNoEntity(self._client, opts)
    ...
    def data_get(self) -> UserProvisioningCollectionResponsePublicPermissionSetNo:
    ...
    def match_get(self) -> UserProvisioningCollectionResponsePublicPermissionSetNo:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[UserProvisioningCollectionResponsePublicPermissionSetNo]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.UserProvisioningCollectionResponsePublicPermissionSetNo().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
