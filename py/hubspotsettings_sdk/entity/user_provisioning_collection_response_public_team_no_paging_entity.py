...
class UserProvisioningCollectionResponsePublicTeamNoPagingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return UserProvisioningCollectionResponsePublicTeamNoPagingEntity(self._client, opts)
    ...
    def data_get(self) -> UserProvisioningCollectionResponsePublicTeamNoPaging:
    ...
    def match_get(self) -> UserProvisioningCollectionResponsePublicTeamNoPaging:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[UserProvisioningCollectionResponsePublicTeamNoPaging]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.UserProvisioningCollectionResponsePublicTeamNoPaging().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
