...
class MulticurrencyCentralExchangeRatesInformationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MulticurrencyCentralExchangeRatesInformationEntity(self._client, opts)
    ...
    def data_get(self) -> MulticurrencyCentralExchangeRatesInformation:
    ...
    def match_get(self) -> MulticurrencyCentralExchangeRatesInformation:
    ...
    def load(self, reqmatch=None, ctrl=None) -> MulticurrencyCentralExchangeRatesInformation:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.MulticurrencyCentralExchangeRatesInformation().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
