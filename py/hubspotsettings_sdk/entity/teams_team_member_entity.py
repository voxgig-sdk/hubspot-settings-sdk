...
class TeamsTeamMemberEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TeamsTeamMemberEntity(self._client, opts)
    ...
    def data_get(self) -> TeamsTeamMember:
    ...
    def match_get(self) -> TeamsTeamMember:
    ...
    def create(self, reqdata: TeamsTeamMemberCreateData, ctrl=None) -> TeamsTeamMember:
        utility = self._utility
