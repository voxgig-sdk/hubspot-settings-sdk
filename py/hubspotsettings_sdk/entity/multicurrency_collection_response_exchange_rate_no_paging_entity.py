...
class MulticurrencyCollectionResponseExchangeRateNoPagingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MulticurrencyCollectionResponseExchangeRateNoPagingEntity(self._client, opts)
    ...
    def data_get(self) -> MulticurrencyCollectionResponseExchangeRateNoPaging:
    ...
    def match_get(self) -> MulticurrencyCollectionResponseExchangeRateNoPaging:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[MulticurrencyCollectionResponseExchangeRateNoPaging]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.MulticurrencyCollectionResponseExchangeRateNoPaging().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
