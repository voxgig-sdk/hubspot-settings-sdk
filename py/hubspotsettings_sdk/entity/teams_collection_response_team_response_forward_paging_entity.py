...
class TeamsCollectionResponseTeamResponseForwardPagingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TeamsCollectionResponseTeamResponseForwardPagingEntity(self._client, opts)
    ...
    def data_get(self) -> TeamsCollectionResponseTeamResponseForwardPaging:
    ...
    def match_get(self) -> TeamsCollectionResponseTeamResponseForwardPaging:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[TeamsCollectionResponseTeamResponseForwardPaging]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.TeamsCollectionResponseTeamResponseForwardPaging().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
