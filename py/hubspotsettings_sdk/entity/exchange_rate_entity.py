...
class ExchangeRateEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ExchangeRateEntity(self._client, opts)
    ...
    def data_get(self) -> ExchangeRate:
    ...
    def match_get(self) -> ExchangeRate:
    ...
    def create(self, reqdata: ExchangeRateCreateData, ctrl=None) -> ExchangeRate:
        utility = self._utility
