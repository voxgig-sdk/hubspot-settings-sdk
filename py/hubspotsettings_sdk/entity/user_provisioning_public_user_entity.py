...
class UserProvisioningPublicUserEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return UserProvisioningPublicUserEntity(self._client, opts)
    ...
    def data_get(self) -> UserProvisioningPublicUser:
    ...
    def match_get(self) -> UserProvisioningPublicUser:
    ...
    def load(self, reqmatch=None, ctrl=None) -> UserProvisioningPublicUser:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.UserProvisioningPublicUser().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: UserProvisioningPublicUserCreateData, ctrl=None) -> UserProvisioningPublicUser:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: UserProvisioningPublicUserUpdateData, ctrl=None) -> UserProvisioningPublicUser:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
