...
class MulticurrencyCollectionResponseExchangeRateForwardPagingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MulticurrencyCollectionResponseExchangeRateForwardPagingEntity(self._client, opts)
    ...
    def data_get(self) -> MulticurrencyCollectionResponseExchangeRateForwardPaging:
    ...
    def match_get(self) -> MulticurrencyCollectionResponseExchangeRateForwardPaging:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[MulticurrencyCollectionResponseExchangeRateForwardPaging]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.MulticurrencyCollectionResponseExchangeRateForwardPaging().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
