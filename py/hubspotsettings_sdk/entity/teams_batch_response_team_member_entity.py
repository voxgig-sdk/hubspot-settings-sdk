...
class TeamsBatchResponseTeamMemberEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TeamsBatchResponseTeamMemberEntity(self._client, opts)
    ...
    def data_get(self) -> TeamsBatchResponseTeamMember:
    ...
    def match_get(self) -> TeamsBatchResponseTeamMember:
    ...
    def create(self, reqdata: TeamsBatchResponseTeamMemberCreateData, ctrl=None) -> TeamsBatchResponseTeamMember:
        utility = self._utility
