...
class MulticurrencyExchangeRateEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MulticurrencyExchangeRateEntity(self._client, opts)
    ...
    def data_get(self) -> MulticurrencyExchangeRate:
    ...
    def match_get(self) -> MulticurrencyExchangeRate:
    ...
    def load(self, reqmatch=None, ctrl=None) -> MulticurrencyExchangeRate:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.MulticurrencyExchangeRate().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: MulticurrencyExchangeRateCreateData, ctrl=None) -> MulticurrencyExchangeRate:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: MulticurrencyExchangeRateUpdateData, ctrl=None) -> MulticurrencyExchangeRate:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
