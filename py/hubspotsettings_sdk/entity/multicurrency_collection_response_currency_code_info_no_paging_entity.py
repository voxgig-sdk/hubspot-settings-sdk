...
class MulticurrencyCollectionResponseCurrencyCodeInfoNoPagingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MulticurrencyCollectionResponseCurrencyCodeInfoNoPagingEntity(self._client, opts)
    ...
    def data_get(self) -> MulticurrencyCollectionResponseCurrencyCodeInfoNoPaging:
    ...
    def match_get(self) -> MulticurrencyCollectionResponseCurrencyCodeInfoNoPaging:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[MulticurrencyCollectionResponseCurrencyCodeInfoNoPaging]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.MulticurrencyCollectionResponseCurrencyCodeInfoNoPaging().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
