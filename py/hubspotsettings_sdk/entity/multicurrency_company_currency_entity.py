...
class MulticurrencyCompanyCurrencyEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MulticurrencyCompanyCurrencyEntity(self._client, opts)
    ...
    def data_get(self) -> MulticurrencyCompanyCurrency:
    ...
    def match_get(self) -> MulticurrencyCompanyCurrency:
    ...
    def load(self, reqmatch=None, ctrl=None) -> MulticurrencyCompanyCurrency:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.MulticurrencyCompanyCurrency().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def update(self, reqdata: MulticurrencyCompanyCurrencyUpdateData, ctrl=None) -> MulticurrencyCompanyCurrency:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
