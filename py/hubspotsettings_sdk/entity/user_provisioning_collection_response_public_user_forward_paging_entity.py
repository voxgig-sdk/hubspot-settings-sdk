...
class UserProvisioningCollectionResponsePublicUserForwardPagingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return UserProvisioningCollectionResponsePublicUserForwardPagingEntity(self._client, opts)
    ...
    def data_get(self) -> UserProvisioningCollectionResponsePublicUserForwardPaging:
    ...
    def match_get(self) -> UserProvisioningCollectionResponsePublicUserForwardPaging:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[UserProvisioningCollectionResponsePublicUserForwardPaging]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.UserProvisioningCollectionResponsePublicUserForwardPaging().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
