# HubspotSettings SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions HubspotSettingsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both HubspotSettingsSDK(...) and HubspotSettingsSDK.test(...) become
#      HubspotSettingsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "hubspotsettings_sdk"
_SDK_CLASS = "HubspotSettingsSDK"
