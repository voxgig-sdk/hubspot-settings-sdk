...
class TestTeamsCollectionResponseTeamMemberResponseForwardPagingDirect:

    def test_should_direct_list_teams_collection_response_team_member_response_forward_paging(self):
        setup = _teams_collection_response_team_member_response_forward_paging_direct_setup([
            {"id": "direct01"},
            {"id": "direct02"},
        ])
        _skip, _reason = runner.is_control_skipped("direct", "direct-list-teams_collection_response_team_member_response_forward_paging", "live" if setup["live"] else "unit")
        if _skip:
...
def _teams_collection_response_team_member_response_forward_paging_direct_setup(mockres):
