// Command HubspotSettings-mcp is an MCP server exposing the HubspotSettings
// SDK as MCP tools.
//
// Two tools are registered:
//
//	HubspotSettings_list  — list records of an entity
//	HubspotSettings_load  — load a single record of an entity
//
