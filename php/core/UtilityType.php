...
// HubspotSettings SDK utility type

class HubspotSettingsUtility
{
    ...
    public static function copy(HubspotSettingsUtility $src): HubspotSettingsUtility
    {
        $u = new HubspotSettingsUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
