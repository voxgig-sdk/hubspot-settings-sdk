...
// HubspotSettings SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (HubspotSettingsSDK::test)
...
{
    private const SDK_CLASS = 'HubspotSettingsSDK';
    ...
    private const SDK_BASE = 'hubspotsettings_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../hubspotsettings_sdk.php';
