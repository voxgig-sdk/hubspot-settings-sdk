...
class HubspotSettingsTestRunner
{
    ...
    {
        $live = self::getenv('HUBSPOT_SETTINGS_TEST_LIVE');
        $override = self::getenv('HUBSPOT_SETTINGS_TEST_OVERRIDE');
        ...
        $explain = self::getenv('HUBSPOT_SETTINGS_TEST_EXPLAIN');
...
class_alias('HubspotSettingsTestRunner', 'Runner');
class_alias('HubspotSettingsHelpers', 'Helpers');
