...
class TeamsTeamDirectTest extends TestCase
{
    public function test_direct_load_teams_team(): void
    {
        $setup = teams_team_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-teams_team", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function teams_team_direct_setup($mockres)
{
