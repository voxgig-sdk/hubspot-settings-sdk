...
class BasicEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set HUBSPOT_SETTINGS_TEST_BASIC_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function basic_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("HUBSPOT_SETTINGS_TEST_BASIC_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["HUBSPOT_SETTINGS_TEST_BASIC_ENTID"]);
