...
// HubspotSettings SDK paging feature
...
class HubspotSettingsPagingFeature extends HubspotSettingsBaseFeature
{
    ...
    private function _graphql_pre_request(HubspotSettingsContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(HubspotSettingsContext $ctx): bool
    {
