...
class UserProvisioningCollectionResponsePublicPermissionSetNoEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "user_provisioning_collection_response_public_permission_set_no";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new UserProvisioningCollectionResponsePublicPermissionSetNoEntity($this->_client, $opts);
    }

    /**
     * @param UserProvisioningCollectionResponsePublicPermissionSetNo|array $args UserProvisioningCollectionResponsePublicPermissionSetNo data (assoc-array) to store.
     */
    ...
    /**
     * @return UserProvisioningCollectionResponsePublicPermissionSetNo|array The current UserProvisioningCollectionResponsePublicPermissionSetNo data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UserProvisioningCollectionResponsePublicPermissionSetNo fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UserProvisioningCollectionResponsePublicPermissionSetNo fields).
     */
    ...
    /**
     * List UserProvisioningCollectionResponsePublicPermissionSetNo items matching the given filter.
     *
     * @param UserProvisioningCollectionResponsePublicPermissionSetNoListMatch|array|null $reqmatch Match filter (any subset
     *   of UserProvisioningCollectionResponsePublicPermissionSetNo fields) as an assoc-array; UserProvisioningCollectionResponsePublicPermissionSetNoListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UserProvisioningCollectionResponsePublicPermissionSetNo[]|array A list of UserProvisioningCollectionResponsePublicPermissionSetNo items as assoc-arrays at
