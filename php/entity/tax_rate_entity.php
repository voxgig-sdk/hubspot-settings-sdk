...
// HubspotSettings SDK TaxRate entity
...
class TaxRateEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TaxRateEntity($this->_client, $opts);
    }

    /**
     * @param TaxRate|array $args TaxRate data (assoc-array) to store.
     */
    ...
    /**
     * @return TaxRate|array The current TaxRate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TaxRate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TaxRate fields).
     */
    ...
    /**
     * Load a single TaxRate.
     *
     * @param TaxRateLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed TaxRateLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TaxRate|array The loaded TaxRate as an assoc-array at the
    ...
    /**
     * List TaxRate items matching the given filter.
     *
     * @param TaxRateListMatch|array|null $reqmatch Match filter (any subset
     *   of TaxRate fields) as an assoc-array; TaxRateListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TaxRate[]|array A list of TaxRate items as assoc-arrays at
