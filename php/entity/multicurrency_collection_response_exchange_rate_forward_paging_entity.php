...
class MulticurrencyCollectionResponseExchangeRateForwardPagingEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "multicurrency_collection_response_exchange_rate_forward_paging";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new MulticurrencyCollectionResponseExchangeRateForwardPagingEntity($this->_client, $opts);
    }

    /**
     * @param MulticurrencyCollectionResponseExchangeRateForwardPaging|array $args MulticurrencyCollectionResponseExchangeRateForwardPaging data (assoc-array) to store.
     */
    ...
    /**
     * @return MulticurrencyCollectionResponseExchangeRateForwardPaging|array The current MulticurrencyCollectionResponseExchangeRateForwardPaging data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MulticurrencyCollectionResponseExchangeRateForwardPaging fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MulticurrencyCollectionResponseExchangeRateForwardPaging fields).
     */
    ...
    /**
     * List MulticurrencyCollectionResponseExchangeRateForwardPaging items matching the given filter.
     *
     * @param MulticurrencyCollectionResponseExchangeRateForwardPagingListMatch|array|null $reqmatch Match filter (any subset
     *   of MulticurrencyCollectionResponseExchangeRateForwardPaging fields) as an assoc-array; MulticurrencyCollectionResponseExchangeRateForwardPagingListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MulticurrencyCollectionResponseExchangeRateForwardPaging[]|array A list of MulticurrencyCollectionResponseExchangeRateForwardPaging items as assoc-arrays at
