...
class MulticurrencyCollectionResponseCurrencyCodeInfoNoPagingEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "multicurrency_collection_response_currency_code_info_no_paging";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new MulticurrencyCollectionResponseCurrencyCodeInfoNoPagingEntity($this->_client, $opts);
    }

    /**
     * @param MulticurrencyCollectionResponseCurrencyCodeInfoNoPaging|array $args MulticurrencyCollectionResponseCurrencyCodeInfoNoPaging data (assoc-array) to store.
     */
    ...
    /**
     * @return MulticurrencyCollectionResponseCurrencyCodeInfoNoPaging|array The current MulticurrencyCollectionResponseCurrencyCodeInfoNoPaging data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MulticurrencyCollectionResponseCurrencyCodeInfoNoPaging fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MulticurrencyCollectionResponseCurrencyCodeInfoNoPaging fields).
     */
    ...
    /**
     * List MulticurrencyCollectionResponseCurrencyCodeInfoNoPaging items matching the given filter.
     *
     * @param MulticurrencyCollectionResponseCurrencyCodeInfoNoPagingListMatch|array|null $reqmatch Match filter (any subset
     *   of MulticurrencyCollectionResponseCurrencyCodeInfoNoPaging fields) as an assoc-array; MulticurrencyCollectionResponseCurrencyCodeInfoNoPagingListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MulticurrencyCollectionResponseCurrencyCodeInfoNoPaging[]|array A list of MulticurrencyCollectionResponseCurrencyCodeInfoNoPaging items as assoc-arrays at
