...
class TeamsCollectionResponseTeamMemberResponseForwardPagingEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "teams_collection_response_team_member_response_forward_paging";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new TeamsCollectionResponseTeamMemberResponseForwardPagingEntity($this->_client, $opts);
    }

    /**
     * @param TeamsCollectionResponseTeamMemberResponseForwardPaging|array $args TeamsCollectionResponseTeamMemberResponseForwardPaging data (assoc-array) to store.
     */
    ...
    /**
     * @return TeamsCollectionResponseTeamMemberResponseForwardPaging|array The current TeamsCollectionResponseTeamMemberResponseForwardPaging data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TeamsCollectionResponseTeamMemberResponseForwardPaging fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TeamsCollectionResponseTeamMemberResponseForwardPaging fields).
     */
    ...
    /**
     * List TeamsCollectionResponseTeamMemberResponseForwardPaging items matching the given filter.
     *
     * @param TeamsCollectionResponseTeamMemberResponseForwardPagingListMatch|array|null $reqmatch Match filter (any subset
     *   of TeamsCollectionResponseTeamMemberResponseForwardPaging fields) as an assoc-array; TeamsCollectionResponseTeamMemberResponseForwardPagingListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TeamsCollectionResponseTeamMemberResponseForwardPaging[]|array A list of TeamsCollectionResponseTeamMemberResponseForwardPaging items as assoc-arrays at
