...
class TeamsCollectionResponseTeamResponseForwardPagingEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "teams_collection_response_team_response_forward_paging";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new TeamsCollectionResponseTeamResponseForwardPagingEntity($this->_client, $opts);
    }

    /**
     * @param TeamsCollectionResponseTeamResponseForwardPaging|array $args TeamsCollectionResponseTeamResponseForwardPaging data (assoc-array) to store.
     */
    ...
    /**
     * @return TeamsCollectionResponseTeamResponseForwardPaging|array The current TeamsCollectionResponseTeamResponseForwardPaging data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TeamsCollectionResponseTeamResponseForwardPaging fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TeamsCollectionResponseTeamResponseForwardPaging fields).
     */
    ...
    /**
     * List TeamsCollectionResponseTeamResponseForwardPaging items matching the given filter.
     *
     * @param TeamsCollectionResponseTeamResponseForwardPagingListMatch|array|null $reqmatch Match filter (any subset
     *   of TeamsCollectionResponseTeamResponseForwardPaging fields) as an assoc-array; TeamsCollectionResponseTeamResponseForwardPagingListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TeamsCollectionResponseTeamResponseForwardPaging[]|array A list of TeamsCollectionResponseTeamResponseForwardPaging items as assoc-arrays at
