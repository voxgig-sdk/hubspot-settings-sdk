...
class TeamsBatchResponseTeamMemberEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "teams_batch_response_team_member";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new TeamsBatchResponseTeamMemberEntity($this->_client, $opts);
    }

    /**
     * @param TeamsBatchResponseTeamMember|array $args TeamsBatchResponseTeamMember data (assoc-array) to store.
     */
    ...
    /**
     * @return TeamsBatchResponseTeamMember|array The current TeamsBatchResponseTeamMember data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TeamsBatchResponseTeamMember fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TeamsBatchResponseTeamMember fields).
     */
    ...
    /**
     * Create a new TeamsBatchResponseTeamMember.
     *
     * @param TeamsBatchResponseTeamMemberCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TeamsBatchResponseTeamMemberCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TeamsBatchResponseTeamMember|array The created TeamsBatchResponseTeamMember as an assoc-array at the
