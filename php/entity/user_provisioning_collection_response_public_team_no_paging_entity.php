...
class UserProvisioningCollectionResponsePublicTeamNoPagingEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "user_provisioning_collection_response_public_team_no_paging";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new UserProvisioningCollectionResponsePublicTeamNoPagingEntity($this->_client, $opts);
    }

    /**
     * @param UserProvisioningCollectionResponsePublicTeamNoPaging|array $args UserProvisioningCollectionResponsePublicTeamNoPaging data (assoc-array) to store.
     */
    ...
    /**
     * @return UserProvisioningCollectionResponsePublicTeamNoPaging|array The current UserProvisioningCollectionResponsePublicTeamNoPaging data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UserProvisioningCollectionResponsePublicTeamNoPaging fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UserProvisioningCollectionResponsePublicTeamNoPaging fields).
     */
    ...
    /**
     * List UserProvisioningCollectionResponsePublicTeamNoPaging items matching the given filter.
     *
     * @param UserProvisioningCollectionResponsePublicTeamNoPagingListMatch|array|null $reqmatch Match filter (any subset
     *   of UserProvisioningCollectionResponsePublicTeamNoPaging fields) as an assoc-array; UserProvisioningCollectionResponsePublicTeamNoPagingListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UserProvisioningCollectionResponsePublicTeamNoPaging[]|array A list of UserProvisioningCollectionResponsePublicTeamNoPaging items as assoc-arrays at
