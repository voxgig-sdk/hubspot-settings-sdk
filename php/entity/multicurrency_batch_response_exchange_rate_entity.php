...
class MulticurrencyBatchResponseExchangeRateEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "multicurrency_batch_response_exchange_rate";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new MulticurrencyBatchResponseExchangeRateEntity($this->_client, $opts);
    }

    /**
     * @param MulticurrencyBatchResponseExchangeRate|array $args MulticurrencyBatchResponseExchangeRate data (assoc-array) to store.
     */
    ...
    /**
     * @return MulticurrencyBatchResponseExchangeRate|array The current MulticurrencyBatchResponseExchangeRate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MulticurrencyBatchResponseExchangeRate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MulticurrencyBatchResponseExchangeRate fields).
     */
    ...
    /**
     * Create a new MulticurrencyBatchResponseExchangeRate.
     *
     * @param MulticurrencyBatchResponseExchangeRateCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MulticurrencyBatchResponseExchangeRateCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MulticurrencyBatchResponseExchangeRate|array The created MulticurrencyBatchResponseExchangeRate as an assoc-array at the
