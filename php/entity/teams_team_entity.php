...
// HubspotSettings SDK TeamsTeam entity
...
class TeamsTeamEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TeamsTeamEntity($this->_client, $opts);
    }

    /**
     * @param TeamsTeam|array $args TeamsTeam data (assoc-array) to store.
     */
    ...
    /**
     * @return TeamsTeam|array The current TeamsTeam data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TeamsTeam fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TeamsTeam fields).
     */
    ...
    /**
     * Load a single TeamsTeam.
     *
     * @param TeamsTeamLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed TeamsTeamLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TeamsTeam|array The loaded TeamsTeam as an assoc-array at the
    ...
    /**
     * Create a new TeamsTeam.
     *
     * @param TeamsTeamCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TeamsTeamCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TeamsTeam|array The created TeamsTeam as an assoc-array at the
     *   SDK boundary; throws HubspotSettingsError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing TeamsTeam.
     *
     * @param TeamsTeamUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TeamsTeamUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TeamsTeam|array The updated TeamsTeam as an assoc-array at the
     *   SDK boundary; throws HubspotSettingsError on failure (item-5 convention).
     */
