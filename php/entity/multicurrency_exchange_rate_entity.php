...
// HubspotSettings SDK MulticurrencyExchangeRate entity
...
class MulticurrencyExchangeRateEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "multicurrency_exchange_rate";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new MulticurrencyExchangeRateEntity($this->_client, $opts);
    }

    /**
     * @param MulticurrencyExchangeRate|array $args MulticurrencyExchangeRate data (assoc-array) to store.
     */
    ...
    /**
     * @return MulticurrencyExchangeRate|array The current MulticurrencyExchangeRate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MulticurrencyExchangeRate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MulticurrencyExchangeRate fields).
     */
    ...
    /**
     * Load a single MulticurrencyExchangeRate.
     *
     * @param MulticurrencyExchangeRateLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MulticurrencyExchangeRateLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MulticurrencyExchangeRate|array The loaded MulticurrencyExchangeRate as an assoc-array at the
    ...
    /**
     * Create a new MulticurrencyExchangeRate.
     *
     * @param MulticurrencyExchangeRateCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MulticurrencyExchangeRateCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MulticurrencyExchangeRate|array The created MulticurrencyExchangeRate as an assoc-array at the
     *   SDK boundary; throws HubspotSettingsError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing MulticurrencyExchangeRate.
     *
     * @param MulticurrencyExchangeRateUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MulticurrencyExchangeRateUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MulticurrencyExchangeRate|array The updated MulticurrencyExchangeRate as an assoc-array at the
     *   SDK boundary; throws HubspotSettingsError on failure (item-5 convention).
     */
