...
class TeamsTeamMemberEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TeamsTeamMemberEntity($this->_client, $opts);
    }

    /**
     * @param TeamsTeamMember|array $args TeamsTeamMember data (assoc-array) to store.
     */
    ...
    /**
     * @return TeamsTeamMember|array The current TeamsTeamMember data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TeamsTeamMember fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TeamsTeamMember fields).
     */
    ...
    /**
     * Create a new TeamsTeamMember.
     *
     * @param TeamsTeamMemberCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TeamsTeamMemberCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TeamsTeamMember|array The created TeamsTeamMember as an assoc-array at the
