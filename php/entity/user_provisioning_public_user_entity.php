...
// HubspotSettings SDK UserProvisioningPublicUser entity
...
class UserProvisioningPublicUserEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "user_provisioning_public_user";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new UserProvisioningPublicUserEntity($this->_client, $opts);
    }

    /**
     * @param UserProvisioningPublicUser|array $args UserProvisioningPublicUser data (assoc-array) to store.
     */
    ...
    /**
     * @return UserProvisioningPublicUser|array The current UserProvisioningPublicUser data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UserProvisioningPublicUser fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UserProvisioningPublicUser fields).
     */
    ...
    /**
     * Load a single UserProvisioningPublicUser.
     *
     * @param UserProvisioningPublicUserLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed UserProvisioningPublicUserLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UserProvisioningPublicUser|array The loaded UserProvisioningPublicUser as an assoc-array at the
    ...
    /**
     * Create a new UserProvisioningPublicUser.
     *
     * @param UserProvisioningPublicUserCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed UserProvisioningPublicUserCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UserProvisioningPublicUser|array The created UserProvisioningPublicUser as an assoc-array at the
     *   SDK boundary; throws HubspotSettingsError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing UserProvisioningPublicUser.
     *
     * @param UserProvisioningPublicUserUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed UserProvisioningPublicUserUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UserProvisioningPublicUser|array The updated UserProvisioningPublicUser as an assoc-array at the
     *   SDK boundary; throws HubspotSettingsError on failure (item-5 convention).
     */
