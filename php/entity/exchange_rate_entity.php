...
class ExchangeRateEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ExchangeRateEntity($this->_client, $opts);
    }

    /**
     * @param ExchangeRate|array $args ExchangeRate data (assoc-array) to store.
     */
    ...
    /**
     * @return ExchangeRate|array The current ExchangeRate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ExchangeRate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ExchangeRate fields).
     */
     ...
     *
     * @param ExchangeRateCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ExchangeRateCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ExchangeRate|array The created ExchangeRate as an assoc-array at the
