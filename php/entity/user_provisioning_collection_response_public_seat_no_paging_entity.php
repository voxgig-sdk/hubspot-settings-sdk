...
class UserProvisioningCollectionResponsePublicSeatNoPagingEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "user_provisioning_collection_response_public_seat_no_paging";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new UserProvisioningCollectionResponsePublicSeatNoPagingEntity($this->_client, $opts);
    }

    /**
     * @param UserProvisioningCollectionResponsePublicSeatNoPaging|array $args UserProvisioningCollectionResponsePublicSeatNoPaging data (assoc-array) to store.
     */
    ...
    /**
     * @return UserProvisioningCollectionResponsePublicSeatNoPaging|array The current UserProvisioningCollectionResponsePublicSeatNoPaging data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UserProvisioningCollectionResponsePublicSeatNoPaging fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UserProvisioningCollectionResponsePublicSeatNoPaging fields).
     */
    ...
    /**
     * List UserProvisioningCollectionResponsePublicSeatNoPaging items matching the given filter.
     *
     * @param UserProvisioningCollectionResponsePublicSeatNoPagingListMatch|array|null $reqmatch Match filter (any subset
     *   of UserProvisioningCollectionResponsePublicSeatNoPaging fields) as an assoc-array; UserProvisioningCollectionResponsePublicSeatNoPagingListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UserProvisioningCollectionResponsePublicSeatNoPaging[]|array A list of UserProvisioningCollectionResponsePublicSeatNoPaging items as assoc-arrays at
