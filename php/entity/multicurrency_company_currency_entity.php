...
// HubspotSettings SDK MulticurrencyCompanyCurrency entity
...
class MulticurrencyCompanyCurrencyEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "multicurrency_company_currency";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new MulticurrencyCompanyCurrencyEntity($this->_client, $opts);
    }

    /**
     * @param MulticurrencyCompanyCurrency|array $args MulticurrencyCompanyCurrency data (assoc-array) to store.
     */
    ...
    /**
     * @return MulticurrencyCompanyCurrency|array The current MulticurrencyCompanyCurrency data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MulticurrencyCompanyCurrency fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MulticurrencyCompanyCurrency fields).
     */
    ...
    /**
     * Load a single MulticurrencyCompanyCurrency.
     *
     * @param MulticurrencyCompanyCurrencyLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MulticurrencyCompanyCurrencyLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MulticurrencyCompanyCurrency|array The loaded MulticurrencyCompanyCurrency as an assoc-array at the
    ...
    /**
     * Update an existing MulticurrencyCompanyCurrency.
     *
     * @param MulticurrencyCompanyCurrencyUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MulticurrencyCompanyCurrencyUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MulticurrencyCompanyCurrency|array The updated MulticurrencyCompanyCurrency as an assoc-array at the
     *   SDK boundary; throws HubspotSettingsError on failure (item-5 convention).
     */
