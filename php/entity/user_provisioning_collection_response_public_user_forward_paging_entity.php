...
class UserProvisioningCollectionResponsePublicUserForwardPagingEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "user_provisioning_collection_response_public_user_forward_paging";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new UserProvisioningCollectionResponsePublicUserForwardPagingEntity($this->_client, $opts);
    }

    /**
     * @param UserProvisioningCollectionResponsePublicUserForwardPaging|array $args UserProvisioningCollectionResponsePublicUserForwardPaging data (assoc-array) to store.
     */
    public function data_set($args): void
    {
        if ($args) {
            $this->_data = HubspotSettingsHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetData");
        }
    }

    /**
     * @return UserProvisioningCollectionResponsePublicUserForwardPaging|array The current UserProvisioningCollectionResponsePublicUserForwardPaging data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UserProvisioningCollectionResponsePublicUserForwardPaging fields).
     */
    public function match_set($args): void
    {
        if ($args) {
            $this->_match = HubspotSettingsHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetMatch");
        }
    }

    /**
     * @return array The current match filter (any subset of UserProvisioningCollectionResponsePublicUserForwardPaging fields).
     */
    ...
    /**
     * List UserProvisioningCollectionResponsePublicUserForwardPaging items matching the given filter.
     *
     * @param UserProvisioningCollectionResponsePublicUserForwardPagingListMatch|array|null $reqmatch Match filter (any subset
     *   of UserProvisioningCollectionResponsePublicUserForwardPaging fields) as an assoc-array; UserProvisioningCollectionResponsePublicUserForwardPagingListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UserProvisioningCollectionResponsePublicUserForwardPaging[]|array A list of UserProvisioningCollectionResponsePublicUserForwardPaging items as assoc-arrays at
     *   the SDK boundary; throws HubspotSettingsError on failure (item-5 convention).
     */
