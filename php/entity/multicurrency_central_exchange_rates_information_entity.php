...
class MulticurrencyCentralExchangeRatesInformationEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "multicurrency_central_exchange_rates_information";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new MulticurrencyCentralExchangeRatesInformationEntity($this->_client, $opts);
    }

    /**
     * @param MulticurrencyCentralExchangeRatesInformation|array $args MulticurrencyCentralExchangeRatesInformation data (assoc-array) to store.
     */
    ...
    /**
     * @return MulticurrencyCentralExchangeRatesInformation|array The current MulticurrencyCentralExchangeRatesInformation data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MulticurrencyCentralExchangeRatesInformation fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MulticurrencyCentralExchangeRatesInformation fields).
     */
    ...
    /**
     * Load a single MulticurrencyCentralExchangeRatesInformation.
     *
     * @param MulticurrencyCentralExchangeRatesInformationLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MulticurrencyCentralExchangeRatesInformationLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MulticurrencyCentralExchangeRatesInformation|array The loaded MulticurrencyCentralExchangeRatesInformation as an assoc-array at the
