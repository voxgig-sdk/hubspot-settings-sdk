...
class MulticurrencyCollectionResponseExchangeRateNoPagingEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "multicurrency_collection_response_exchange_rate_no_paging";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new MulticurrencyCollectionResponseExchangeRateNoPagingEntity($this->_client, $opts);
    }

    /**
     * @param MulticurrencyCollectionResponseExchangeRateNoPaging|array $args MulticurrencyCollectionResponseExchangeRateNoPaging data (assoc-array) to store.
     */
    ...
    /**
     * @return MulticurrencyCollectionResponseExchangeRateNoPaging|array The current MulticurrencyCollectionResponseExchangeRateNoPaging data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MulticurrencyCollectionResponseExchangeRateNoPaging fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MulticurrencyCollectionResponseExchangeRateNoPaging fields).
     */
    ...
    /**
     * List MulticurrencyCollectionResponseExchangeRateNoPaging items matching the given filter.
     *
     * @param MulticurrencyCollectionResponseExchangeRateNoPagingListMatch|array|null $reqmatch Match filter (any subset
     *   of MulticurrencyCollectionResponseExchangeRateNoPaging fields) as an assoc-array; MulticurrencyCollectionResponseExchangeRateNoPagingListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MulticurrencyCollectionResponseExchangeRateNoPaging[]|array A list of MulticurrencyCollectionResponseExchangeRateNoPaging items as assoc-arrays at
