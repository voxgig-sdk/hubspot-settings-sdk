...
// HubspotSettings SDK utility: result_basic

class HubspotSettingsResultBasic
{
    public static function call(HubspotSettingsContext $ctx): ?HubspotSettingsResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof HubspotSettingsError) ? $result->err->msg : (string)$result->err;
