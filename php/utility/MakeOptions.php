...
// HubspotSettings SDK utility: make_options

class HubspotSettingsMakeOptions
{
    ...
    public static function call(HubspotSettingsContext $ctx): array
    {
        ...
        //
        // `HubspotSettingsSchema::optspec()` is built from the model:
        ...
        $optspec = HubspotSettingsSchema::optspec();
