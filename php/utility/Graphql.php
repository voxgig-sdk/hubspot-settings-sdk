...
// HubspotSettings SDK utility: graphql
//
...
class HubspotSettingsGraphql
{
    ...
    // equivalent.
    public static function body(HubspotSettingsContext $ctx): mixed
    {
    ...
    public static function errors(HubspotSettingsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
