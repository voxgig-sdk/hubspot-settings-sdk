// Command HubspotSettings-cli is a CLI + REPL for the HubspotSettings SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      HUBSPOT_SETTINGS_APIKEY (api key), HUBSPOT_SETTINGS_BASE (base url override)")
...
func run(args []string, in io.Reader, out, errOut io.Writer) int {
	...
	// Configure from the environment: HUBSPOT_SETTINGS_APIKEY carries the API key and
	// HUBSPOT_SETTINGS_BASE optionally overrides the API base URL (e.g. production).
	// Both injectable by a secrets vault. Unset -> nil config defaults.
	var opts map[string]any
	if apikey := os.Getenv("HUBSPOT_SETTINGS_APIKEY"); apikey != "" {
		opts = map[string]any{"apikey": apikey}
	}
	if base := os.Getenv("HUBSPOT_SETTINGS_BASE"); base != "" {
		if opts == nil {
			opts = map[string]any{}
		}
		opts["base"] = base
	}
	client := sdk.NewHubspotSettingsSDK(opts)
