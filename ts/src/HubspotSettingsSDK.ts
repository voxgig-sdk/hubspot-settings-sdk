...
class HubspotSettingsSDK {
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('HubspotSettingsSDK: graphql: ' +
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  MulticurrencyBatchResponseExchangeRate(entopts?: Record<string, any>) {
    const self = this
    return new MulticurrencyBatchResponseExchangeRateEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  MulticurrencyCentralExchangeRatesInformation(entopts?: Record<string, any>) {
    const self = this
    return new MulticurrencyCentralExchangeRatesInformationEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  MulticurrencyCollectionResponseExchangeRateForwardPaging(entopts?: Record<string, any>) {
    const self = this
    return new MulticurrencyCollectionResponseExchangeRateForwardPagingEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  TeamsBatchResponseTeamMember(entopts?: Record<string, any>) {
    const self = this
    return new TeamsBatchResponseTeamMemberEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  TeamsCollectionResponseTeamMemberResponseForwardPaging(entopts?: Record<string, any>) {
    const self = this
    return new TeamsCollectionResponseTeamMemberResponseForwardPagingEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  TeamsCollectionResponseTeamResponseForwardPaging(entopts?: Record<string, any>) {
    const self = this
    return new TeamsCollectionResponseTeamResponseForwardPagingEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  TeamsTeam(entopts?: Record<string, any>) {
    const self = this
    return new TeamsTeamEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  TeamsTeamMember(entopts?: Record<string, any>) {
    const self = this
    return new TeamsTeamMemberEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  UserProvisioningPublicUser(entopts?: Record<string, any>) {
    const self = this
    return new UserProvisioningPublicUserEntity(self, entopts)
  }
