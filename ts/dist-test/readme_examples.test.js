...
const __1 = require("..");
const SDK_NAME = 'HubspotSettingsSDK';
...
const TEST_SEED = { "entity": { "basic": { "test01": { "id": "test01" } }, "exchange_rate": { "test01": { "id": "test01" } }, "multicurrency_batch_response_exchange_rate": { "test01": { "id": "test01" } }, "multicurrency_central_exchange_rates_information": { "test01": { "id": "test01" } }, "multicurrency_collection_response_currency_code_info_no_paging": { "test01": { "id": "test01" } }, "multicurrency_collection_response_exchange_rate_forward_paging": { "test01": { "id": "test01" } }, "multicurrency_collection_response_exchange_rate_no_paging": { "test01": { "id": "test01" } }, "multicurrency_company_currency": { "test01": { "id": "test01" } }, "multicurrency_exchange_rate": { "test01": { "id": "test01" } }, "tax_rate": { "test01": { "id": "test01" } }, "teams_batch_response_team_member": { "test01": { "id": "test01" } }, "teams_collection_response_team_member_response_forward_paging": { "test01": { "id": "test01" } }, "teams_collection_response_team_response_forward_paging": { "test01": { "id": "test01" } }, "teams_team": { "test01": { "id": "test01" } }, "teams_team_member": { "test01": { "id": "test01" } }, "user": { "test01": { "id": "test01" } }, "user_provisioning_collection_response_public_permission_set_no": { "test01": { "id": "test01" } }, "user_provisioning_collection_response_public_seat_no_paging": { "test01": { "id": "test01" } }, "user_provisioning_collection_response_public_team_no_paging": { "test01": { "id": "test01" } }, "user_provisioning_collection_response_public_user_forward_paging": { "test01": { "id": "test01" } }, "user_provisioning_public_user": { "test01": { "id": "test01" } } } };
...
function isRunnable(code) {
    return (/new\s+HubspotSettingsSDK\b/.test(code) ||
        /\bHubspotSettingsSDK\.test\b/.test(code) ||
        /\bclient\s*\./.test(code));
}
...
function rewriteForRun(code) {
    ...
    out = out.replace(/new\s+HubspotSettingsSDK\s*\([^)]*\)/g, () => SEEDED_CTOR);
    out = out.replace(/HubspotSettingsSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR);
