...
function envOverride(m) {
    if ('TRUE' === process.env.HUBSPOT_SETTINGS_TEST_LIVE ||
        'TRUE' === process.env.HUBSPOT_SETTINGS_TEST_OVERRIDE) {
    ...
    m.HUBSPOT_SETTINGS_TEST_EXPLAIN = process.env.HUBSPOT_SETTINGS_TEST_EXPLAIN || m.HUBSPOT_SETTINGS_TEST_EXPLAIN;
    return m;
}
