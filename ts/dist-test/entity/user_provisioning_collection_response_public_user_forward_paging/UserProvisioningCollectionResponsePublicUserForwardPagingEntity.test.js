...
(0, node_test_1.describe)('UserProvisioningCollectionResponsePublicUserForwardPagingEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/user_provisioning_collection_response_public_user_forward_paging/UserProvisioningCollectionResponsePublicUserForwardPagingTestData.json');
    ...
    let idmap = transform(['user_provisioning_collection_response_public_user_forward_paging01', 'user_provisioning_collection_response_public_user_forward_paging02', 'user_provisioning_collection_response_public_user_forward_paging03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=UserProvisioningCollectionResponsePublicUserForwardPagingEntity.test.js.map