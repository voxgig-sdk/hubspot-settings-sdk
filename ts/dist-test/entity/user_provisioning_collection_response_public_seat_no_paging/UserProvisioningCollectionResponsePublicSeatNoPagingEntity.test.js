...
(0, node_test_1.describe)('UserProvisioningCollectionResponsePublicSeatNoPagingEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/user_provisioning_collection_response_public_seat_no_paging/UserProvisioningCollectionResponsePublicSeatNoPagingTestData.json');
    ...
    let idmap = transform(['user_provisioning_collection_response_public_seat_no_paging01', 'user_provisioning_collection_response_public_seat_no_paging02', 'user_provisioning_collection_response_public_seat_no_paging03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=UserProvisioningCollectionResponsePublicSeatNoPagingEntity.test.js.map