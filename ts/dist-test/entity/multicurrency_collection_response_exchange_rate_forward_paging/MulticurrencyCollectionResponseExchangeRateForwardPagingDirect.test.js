...
(0, node_test_1.describe)('MulticurrencyCollectionResponseExchangeRateForwardPagingDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-multicurrency_collection_response_exchange_rate_forward_paging', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-multicurrency_collection_response_exchange_rate_forward_paging', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HUBSPOT_SETTINGS_TEST_MULTICURRENCY_COLLECTION_RESPONSE_EXCHANGE_RATE_FORWARD_PAGING_ENTID'];
...
//# sourceMappingURL=MulticurrencyCollectionResponseExchangeRateForwardPagingDirect.test.js.map