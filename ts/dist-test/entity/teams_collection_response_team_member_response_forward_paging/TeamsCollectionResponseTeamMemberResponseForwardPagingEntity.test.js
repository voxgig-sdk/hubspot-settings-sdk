...
(0, node_test_1.describe)('TeamsCollectionResponseTeamMemberResponseForwardPagingEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        teams_collection_response_team_member_response_forward_paging_ref01_match['2026_09_id'] = setup.idmap['2026_0901'];
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/teams_collection_response_team_member_response_forward_paging/TeamsCollectionResponseTeamMemberResponseForwardPagingTestData.json');
    ...
    let idmap = transform(['teams_collection_response_team_member_response_forward_paging01', 'teams_collection_response_team_member_response_forward_paging02', 'teams_collection_response_team_member_response_forward_paging03', '2026_0901', '2026_0902', '2026_0903'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=TeamsCollectionResponseTeamMemberResponseForwardPagingEntity.test.js.map