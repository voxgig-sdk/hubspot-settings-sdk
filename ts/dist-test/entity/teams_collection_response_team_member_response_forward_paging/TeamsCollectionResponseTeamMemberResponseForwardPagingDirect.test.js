...
(0, node_test_1.describe)('TeamsCollectionResponseTeamMemberResponseForwardPagingDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-teams_collection_response_team_member_response_forward_paging', async (t) => {
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HUBSPOT_SETTINGS_TEST_TEAMS_COLLECTION_RESPONSE_TEAM_MEMBER_RESPONSE_FORWARD_PAGING_ENTID'];
...
//# sourceMappingURL=TeamsCollectionResponseTeamMemberResponseForwardPagingDirect.test.js.map