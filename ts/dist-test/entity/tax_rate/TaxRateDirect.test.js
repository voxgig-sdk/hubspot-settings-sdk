...
(0, node_test_1.describe)('TaxRateDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-tax_rate', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-tax_rate', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-tax_rate', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-tax_rate', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HUBSPOT_SETTINGS_TEST_TAX_RATE_ENTID'];
...
//# sourceMappingURL=TaxRateDirect.test.js.map