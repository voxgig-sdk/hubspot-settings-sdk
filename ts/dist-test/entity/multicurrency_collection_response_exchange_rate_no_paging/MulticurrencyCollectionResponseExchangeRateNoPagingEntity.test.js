...
(0, node_test_1.describe)('MulticurrencyCollectionResponseExchangeRateNoPagingEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'multicurrency_collection_response_exchange_rate_no_paging.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/multicurrency_collection_response_exchange_rate_no_paging/MulticurrencyCollectionResponseExchangeRateNoPagingTestData.json');
    ...
    let idmap = transform(['multicurrency_collection_response_exchange_rate_no_paging01', 'multicurrency_collection_response_exchange_rate_no_paging02', 'multicurrency_collection_response_exchange_rate_no_paging03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=MulticurrencyCollectionResponseExchangeRateNoPagingEntity.test.js.map