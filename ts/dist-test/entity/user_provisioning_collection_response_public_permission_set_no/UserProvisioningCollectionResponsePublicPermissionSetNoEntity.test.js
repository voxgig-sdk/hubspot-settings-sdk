...
(0, node_test_1.describe)('UserProvisioningCollectionResponsePublicPermissionSetNoEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'user_provisioning_collection_response_public_permission_set_no.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/user_provisioning_collection_response_public_permission_set_no/UserProvisioningCollectionResponsePublicPermissionSetNoTestData.json');
    ...
    let idmap = transform(['user_provisioning_collection_response_public_permission_set_no01', 'user_provisioning_collection_response_public_permission_set_no02', 'user_provisioning_collection_response_public_permission_set_no03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=UserProvisioningCollectionResponsePublicPermissionSetNoEntity.test.js.map