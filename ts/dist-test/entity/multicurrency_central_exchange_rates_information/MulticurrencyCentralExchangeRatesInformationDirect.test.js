...
(0, node_test_1.describe)('MulticurrencyCentralExchangeRatesInformationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-multicurrency_central_exchange_rates_information', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-multicurrency_central_exchange_rates_information', setup.live))
            return;
...
//# sourceMappingURL=MulticurrencyCentralExchangeRatesInformationDirect.test.js.map