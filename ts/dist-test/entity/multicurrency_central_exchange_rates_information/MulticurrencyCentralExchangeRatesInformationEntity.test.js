...
(0, node_test_1.describe)('MulticurrencyCentralExchangeRatesInformationEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != multicurrency_central_exchange_rates_information_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/multicurrency_central_exchange_rates_information/MulticurrencyCentralExchangeRatesInformationTestData.json');
    ...
    let idmap = transform(['multicurrency_central_exchange_rates_information01', 'multicurrency_central_exchange_rates_information02', 'multicurrency_central_exchange_rates_information03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=MulticurrencyCentralExchangeRatesInformationEntity.test.js.map