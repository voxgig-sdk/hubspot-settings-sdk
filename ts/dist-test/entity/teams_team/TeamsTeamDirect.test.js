...
(0, node_test_1.describe)('TeamsTeamDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-teams_team', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-teams_team', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["team_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HUBSPOT_SETTINGS_TEST_TEAMS_TEAM_ENTID'];
...
//# sourceMappingURL=TeamsTeamDirect.test.js.map