...
(0, node_test_1.describe)('MulticurrencyCollectionResponseCurrencyCodeInfoNoPagingDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.HubspotSettingsSDK({
    ...
    (0, node_test_1.test)('direct-list-multicurrency_collection_response_currency_code_info_no_paging', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-multicurrency_collection_response_currency_code_info_no_paging', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.HubspotSettingsSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.HUBSPOT_SETTINGS_APIKEY,
        }));
        let idmap = env['HUBSPOT_SETTINGS_TEST_MULTICURRENCY_COLLECTION_RESPONSE_CURRENCY_CODE_INFO_NO_PAGING_ENTID'];
    ...
    const client = new __1.HubspotSettingsSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=MulticurrencyCollectionResponseCurrencyCodeInfoNoPagingDirect.test.js.map