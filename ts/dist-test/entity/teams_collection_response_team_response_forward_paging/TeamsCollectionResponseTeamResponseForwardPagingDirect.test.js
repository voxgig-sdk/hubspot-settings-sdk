...
(0, node_test_1.describe)('TeamsCollectionResponseTeamResponseForwardPagingDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-teams_collection_response_team_response_forward_paging', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-teams_collection_response_team_response_forward_paging', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HUBSPOT_SETTINGS_TEST_TEAMS_COLLECTION_RESPONSE_TEAM_RESPONSE_FORWARD_PAGING_ENTID'];
...
//# sourceMappingURL=TeamsCollectionResponseTeamResponseForwardPagingDirect.test.js.map