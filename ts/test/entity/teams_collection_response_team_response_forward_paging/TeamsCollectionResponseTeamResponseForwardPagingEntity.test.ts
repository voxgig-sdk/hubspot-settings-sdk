...
describe('TeamsCollectionResponseTeamResponseForwardPagingEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['list']) {
      if (!live && maybeSkipControl(t, 'entityOp', 'teams_collection_response_team_response_forward_paging.' + op, live)) return
    }
    ...
    let teams_collection_response_team_response_forward_paging_ref01_data = Object.values(setup.data.existing.teams_collection_response_team_response_forward_paging)[0] as any
    ...
    const teams_collection_response_team_response_forward_paging_ref01_match: any = {}

    const teams_collection_response_team_response_forward_paging_ref01_list = (await teams_collection_response_team_response_forward_paging_ref01_ent.list(teams_collection_response_team_response_forward_paging_ref01_match)).map((e: any) => e.data())
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/teams_collection_response_team_response_forward_paging/TeamsCollectionResponseTeamResponseForwardPagingTestData.json')
