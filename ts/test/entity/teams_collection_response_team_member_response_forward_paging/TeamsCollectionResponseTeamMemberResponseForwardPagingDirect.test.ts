...
describe('TeamsCollectionResponseTeamMemberResponseForwardPagingDirect', async () => {
  ...
  test('direct-list-teams_collection_response_team_member_response_forward_paging', async (t: any) => {
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['HUBSPOT_SETTINGS_TEST_TEAMS_COLLECTION_RESPONSE_TEAM_MEMBER_RESPONSE_FORWARD_PAGING_ENTID']
