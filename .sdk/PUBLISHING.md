...
|---|---|---|
| `js/` | @voxgig-sdk/hubspot-settings-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/hubspot-settings | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/hubspot-settings-js \
      --repository voxgig-sdk/hubspot-settings-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/hubspot-settings-js` shows it, and
`npm trust revoke @voxgig-sdk/hubspot-settings-js --id=<id>` removes it.
