...
// HubspotSettings SDK ratelimit feature
...
class HubspotSettingsRatelimitFeature extends HubspotSettingsBaseFeature
{
    ...
    private function _acquire(HubspotSettingsContext $ctx): void
    {
    ...
    private function _track(HubspotSettingsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
