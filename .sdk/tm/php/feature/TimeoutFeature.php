...
// HubspotSettings SDK timeout feature
...
class HubspotSettingsTimeoutFeature extends HubspotSettingsBaseFeature
{
    ...
    private function _with_timeout(HubspotSettingsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(HubspotSettingsContext $_ctx, float $ms): void
    {
        $client = $this->client;
