...
// HubspotSettings SDK pipeline test
//
...
{
    private static function utility(): HubspotSettingsUtility
    {
        return new HubspotSettingsUtility();
    }
    ...
    private static function ctx(array $over = []): HubspotSettingsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new HubspotSettingsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new HubspotSettingsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof HubspotSettingsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new HubspotSettingsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = HubspotSettingsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new HubspotSettingsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = HubspotSettingsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new HubspotSettingsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = HubspotSettingsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new HubspotSettingsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = HubspotSettingsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new HubspotSettingsResponse([]),
            'result' => new HubspotSettingsResult([]),
        ]);
        [, $err] = HubspotSettingsMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new HubspotSettingsSpec([]),
            'response' => null,
            'result' => new HubspotSettingsResult([]),
        ]);
        [, $err] = HubspotSettingsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new HubspotSettingsSpec(['step' => 's']),
            'response' => new HubspotSettingsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new HubspotSettingsResult([]),
        ]);
        [, $err] = HubspotSettingsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new HubspotSettingsSpec(['step' => 's']),
            'response' => new HubspotSettingsResponse(self::resp(200, ['v' => 1])),
            'result' => new HubspotSettingsResult([]),
        ]);
        [, $err] = HubspotSettingsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new HubspotSettingsSpec(['step' => 's']),
            'response' => new HubspotSettingsResponse(self::resp(200, ['v' => 2])),
            'result' => new HubspotSettingsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        HubspotSettingsMakeResponse::call($ctx);
    ...
    {
        $preset = new HubspotSettingsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new HubspotSettingsSpec([]),
            'response' => new HubspotSettingsResponse([]),
            'result' => new HubspotSettingsResult([]),
        ...
        [$got, $err] = HubspotSettingsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new HubspotSettingsResult([])]);
        [, $err] = HubspotSettingsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new HubspotSettingsSpec([]), 'result' => null]);
        [, $err] = HubspotSettingsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new HubspotSettingsSpec(['step' => 's']),
            'result' => new HubspotSettingsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new HubspotSettingsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = HubspotSettingsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new HubspotSettingsSpec(['step' => 's']),
            'result' => new HubspotSettingsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new HubspotSettingsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = HubspotSettingsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new HubspotSettingsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new HubspotSettingsSpec([]),
            'result' => new HubspotSettingsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = HubspotSettingsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = HubspotSettingsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new HubspotSettingsError('boom', 'boom');
        $utility->fetcher = function (HubspotSettingsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new HubspotSettingsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = HubspotSettingsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (HubspotSettingsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = HubspotSettingsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(HubspotSettingsResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        HubspotSettingsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (HubspotSettingsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new HubspotSettingsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = HubspotSettingsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new HubspotSettingsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new HubspotSettingsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = HubspotSettingsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = HubspotSettingsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = HubspotSettingsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new HubspotSettingsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, HubspotSettingsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new HubspotSettingsResult(['ok' => false])]);
        $this->expectException(HubspotSettingsError::class);
        HubspotSettingsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new HubspotSettingsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', HubspotSettingsMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        HubspotSettingsMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new HubspotSettingsBaseFeature();
        $b = new HubspotSettingsBaseFeature();
        HubspotSettingsFeatureAdd::call($ctx, $a);
        HubspotSettingsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): HubspotSettingsBaseFeature
    {
        $f = new HubspotSettingsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        HubspotSettingsFeatureAdd::call($ctx, self::named_feature('a'));
        HubspotSettingsFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        HubspotSettingsFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        HubspotSettingsFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        HubspotSettingsFeatureAdd::call($ctx, $replace);
        ...
        HubspotSettingsFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): HubspotSettingsContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new HubspotSettingsSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = HubspotSettingsPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        HubspotSettingsPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new HubspotSettingsResponse(['headers' => null]),
            'result' => new HubspotSettingsResult([]),
        ]);
        HubspotSettingsResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        HubspotSettingsResultBody::call($ctx);
