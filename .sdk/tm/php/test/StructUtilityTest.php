...
// HubspotSettings SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = HubspotSettingsOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(HubspotSettingsOmni::structfix($now, Struct::undef()))
                        !== json_encode(HubspotSettingsOmni::structfix($val, Struct::undef()))) {
