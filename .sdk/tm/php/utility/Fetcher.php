...
// HubspotSettings SDK utility: fetcher

class HubspotSettingsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; HubspotSettingsSDK/1.0)';
    ...
    public static function call(HubspotSettingsContext $ctx, string $fullurl, array $fetchdef): array
    {
