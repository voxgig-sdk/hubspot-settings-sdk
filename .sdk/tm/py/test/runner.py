...
class HubspotSettingsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = HubspotSettingsTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = HubspotSettingsTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = HubspotSettingsTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
